...
if (isset($_SESSION["login"])) {
    header("Location: http://localhost/coba2/views/dashboard");
}
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($credentials) {
        ...
        <script>
            alert('email atau passwordmu salah mek')
            document.location.href = 'http://localhost/coba2/';
        </script>";
    }
}
?>
    ...
    <div id="root" class="container d-flex flex-column gap-5 justify-content-center align-items-center" style="height: 100vh;">
        ...
        <form class="w-50" method="post">
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email" aria-describedby="emailHelp" name="email" autofocus value="andrea@gmail.com">
            </div>
            <div class="mb-3">
            ...
            <div>
                ...
                <a href="http://localhost/coba2/views/user/register/">Register</a>
            </div>
        </form>
    </div>
</body>
